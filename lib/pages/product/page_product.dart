...
import 'package:pos_simple_v2/widgets/atoms/field/field_search.dart';
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      onTap: () => Navigator.of(context).pushNamed(RouteName.PROFILE),
                      child: Row(
                            ...
                            builder: (context, state) {
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  Text("Atur Profil Toko", style: ThemeApp.font.regular.copyWith(fontSize: 10)),
                                ],
                              );
                            },
                          ),
              ...
              FieldSearch(
                ...
                onChange: (res) => blocProduct.onGetProduct(where: "name like '%$res%'"),
              ),
              const SizedBox(height: 10),
              Expanded(
